...
namespace CheapestHotel
{
    ...
    public class HotelLakewood : IHotels
    {
        ...
        private const string _nameOfTheHotel = "lakewood";
        #endregion

        #region Constructor
        public HotelLakewood(string customerTypeRegular, string customerTypeReward, double priceOnAWeekDayforRegular, double priceOnAWeekendForRegular, double priceOnAWeekDayforReward, double priceOnAWeekendForReward)
        {
        ...
        public Hotels GetHotelInformation(string customerType, DateTime date)
        {
            try
            {
                Hotels hotels = new Hotels
                {
                    ...
                    RatingOfTheHotel = Convert.ToInt32(RatingOfHotels.lakewood),
