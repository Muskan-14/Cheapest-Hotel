...
namespace CheapestHotel
{
    class HotelRidgewood : IHotels
    {
        ...
        private const string _nameOfTheHotel = "ridgewood";
        #endregion

        #region Constructor
        public HotelRidgewood(string customerTypeRegular, string customerTypeReward, double priceOnAWeekDayforRegular, double priceOnAWeekendForRegular, double priceOnAWeekDayforReward, double priceOnAWeekendForReward)
        {
        ...
        public Hotels GetHotelInformation(string customerType, DateTime date)
        {
            try
            {
                Hotels hotels = new Hotels
                {
                    ...
                    RatingOfTheHotel = Convert.ToInt32(RatingOfHotels.ridgewood),
